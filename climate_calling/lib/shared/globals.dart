...
FlutterScreenManager flutterScreenManager =
    FlutterScreenManager(); //Screen manager that manages betweeen flutter widgets with flame widgets
ClimateCalling climateCalling = ClimateCalling(); //The game itself
List<NPCSprite> guidedNPCs =
    List(); //Variable to allow multiple NPCs being guided by the player
ScreenState screenState =
    ScreenState.kMainMenu; //Keeps track of the screen states.
